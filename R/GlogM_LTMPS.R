#' @title MPS estimation of the Left-truncated log-Moyal distribution
#' @description Apply MPS estimation to the left-truncated log-Moyal distribution.
#' @param data Empirical data that is left-truncated.
#' @param init_value  The initial value of left-truncated log-Moyal distributions parameters mean and sigma
